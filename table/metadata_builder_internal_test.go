...
// add-sort-order update for the existing ID (catalogs reject those);
// the following set-default-sort-order must carry the concrete reused
// ID so the update payload stays self-contained.
